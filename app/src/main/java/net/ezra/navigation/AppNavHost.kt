...
import net.ezra.ui.studentslist.FirestoreViewModel
import net.ezra.ui.studentslist.StudentsList
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(ROUTE_StudentsList) {
            StudentsList(navController =  navController, viewModel = viewModel())
        }
